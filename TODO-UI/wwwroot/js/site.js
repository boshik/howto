            ...
            <form onSubmit={this.handleSubmit} autoComplete='off'>
                <div className="input-field-wrap row">
                    <div className={(this.state.activeNav ? 'active ' : '') + 'todo-menu'}>
                        <i className={!this.state.activeNav ? 'material-icons ' : ''} onClick={this.toggleNav}>
                            {!this.state.activeNav ? 'subjects' : (<span>&times;</span>)}
                        </i>
                        <ul className='dropdown-content' onClick={this.toggleNav}>
                            <li>
                                <a onClick={this.props.completeAllTodo}>
                                    <i className='material-icons'>done_all</i> Mark all complete
                </a>
                            </li>
                            <li>
                                <a onClick={this.props.removeCompletedTodo}>
                                    <i className='material-icons text-red'>delete</i>  Remove all completed
                </a>
                            </li>
